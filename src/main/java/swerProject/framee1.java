...
public class framee1 extends JFrame {
	...
	public framee1() {
		...
		btnSave_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (employeeage.getText().equals("") || employeesalary.getText().equals("")|| employeename.getText().equals("")||employeecity.getText().equals("")||employeestreet.getText().equals("")|| employeehouse.getText().equals("") ) {
		...
		btnSave_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if (studentage.getText().equals("") || studentgrade.getText().equals("") || studentName.getText().equals("")|| studentcity.getText().equals("")||studentstreet.getText().equals("")|| studenthouse.getText().equals("")) {
					JOptionPane.showMessageDialog(null, "Fill all information");
				} else {
